<template>
    <div class="nav-empty-container" :class="[{ dark: theme === 'dark' }]">
        <img
            draggable="false"
        ...
        <div class="nec-d1">
            <div class="nec-icon-block">
                <img draggable="false" :src="img.partition" alt="" class="empty-icon-img" />
                <img draggable="false" :src="img.group" alt="" class="empty-icon-img" />
            </div>
