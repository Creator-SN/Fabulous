            ...
            >
                <template v-slot:listItem="itemSlot">
                    <div
                        ...
                        class="remote-tree-view-search-header"
                    ...
                    <div
                        v-else
                        class="remote-tree-view-search-item"
                        :class="[{ dark: theme === 'dark' }]"
                    >
                        <div class="item-main">
...
export default {
    name: 'remote-tree-view-search-box',
    props: {
        theme: {
            type: String,
            default: 'light'
    ...
    methods: {
        async searchNotebooks() {
            ...
            let res = await this.searchRemoteNotebooks(this.currentDataPath, keyword, 8)
...
<style lang="scss">
.remote-tree-view-search-header {
    width: 100%;
    min-height: 34px;
    padding: 0px 12px;
