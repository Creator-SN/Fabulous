<div align="center">
    ...
    <p>Fabulous Desktop Developer Guide</p>
...
If these secrets are missing, Windows builds can still succeed, but macOS signing or notarization will likely fail.
...
- To restore notarized builds later, use `scripts/release/build-mac-notarized.sh` with valid Apple signing and notarization environment variables.

## Notes

- Automatic update version detection works in development, but real download and install behavior should be verified with packaged app builds.
